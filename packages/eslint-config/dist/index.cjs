...
var import_eslint_config_basic = __toESM(require("@hedgehoglab/eslint-config-basic"), 1);
var import_eslint_config_vue = __toESM(require("@hedgehoglab/eslint-config-vue"), 1);
